...
sn1=Slider(axn1, 'rot 1', -360, 360.0, valinit=0)
sn2=Slider(axn2, 'rot 2', -360, 360.0, valinit=0)
sn3=Slider(axn3, 'rot 3', -360, 360.0, valinit=0)
sn4=Slider(axn4, 'rot 4', -360, 360.0, valinit=0)
sn5=Slider(axn5, 'rot 5', -90, 269.0, valinit=0)
sn6=Slider(axn6, 'rot 6', -360, 360.0, valinit=0)
...
def update(val):
    ...
    valores1=valores
    valores1[1]=valores[1]-90
    valores1[2]=valores[2]-90
    valores1[4]=valores[4]+90
