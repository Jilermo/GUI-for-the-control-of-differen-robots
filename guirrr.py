...
axn1=plt.axes([0.2,0.15,0.65,0.03])
axn2=plt.axes([0.2,0.1,0.65,0.03])
axn3=plt.axes([0.2,0.05,0.65,0.03])

sn1=Slider(axn1, 'rotacion 1', 0, 360.0, valinit=0)
sn2=Slider(axn2, 'rotacion 2', -90, 270.0, valinit=0)
sn3=Slider(axn3, 'rotacion 3', -180, 180.0, valinit=0)
