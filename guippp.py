...
axn1=plt.axes([0.1,0.15,0.65,0.03])
axn2=plt.axes([0.1,0.1,0.65,0.03])
axn3=plt.axes([0.1,0.05,0.65,0.03])

sn1=Slider(axn1, 'Z', 0, 10.0, valinit=5)
sn2=Slider(axn2, 'Y', 0, 10.0, valinit=5)
sn3=Slider(axn3, 'X', 0, 10.0, valinit=5)
